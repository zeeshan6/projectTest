...
import static com.projecttest.newarchitecture.AnimationsList.animationListHead;
...
import static com.projecttest.newarchitecture.animation.Constants.ROTATE;
import static com.projecttest.newarchitecture.animation.Constants.SCALE;
import static com.projecttest.newarchitecture.animation.Constants.SLIDE;
...
// import com.projecttest.newarchitecture.R;
import android.R;
...
public class Splash {
    ...
    public Splash(Context context) {
        ...
        setView();
//        animationList = new com.projecttest.newarchitecture.LinkedList();
        mHandler = new Handler();
    }

    public void setSplashHideAnimation(String animationType) {
        // if (animationType == "FADE") {
        //     dialog.getWindow().getAttributes().windowAnimations = R.anim.fade; //style id
        // } else if (animationType == "SLIDEDOWN") {
        //     dialog.getWindow().getAttributes().windowAnimations = R.anim.slideDown; //style id
        // } else if (animationType == "SLIDELEFT") {
        //     dialog.getWindow().getAttributes().windowAnimations = R.anim.slideLeft; //style id
        // } else 
        if (animationType == "SLIDERIGHT") {
            // dialog.getWindow().getAttributes().windowAnimations; //style id
            this.isHideOnDialogAnimation = true;
            this.hide();
        }
    }
