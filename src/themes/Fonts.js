...
const type = {
  ...
  AvNormal: Platform.OS === 'ios' ? null : 'AvenirLTStd-Black', //'AvenirLTStd-Black', //Platform.OS === 'ios' ? null : 'AvenirLTStd-Black',
  AvRoman: Platform.OS === 'ios' ? null : 'AvenirLTStd-Roman',
};
